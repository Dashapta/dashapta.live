...
const LSidebar = () => {
  ...
  const menuItems = [
    { icon: LayoutDashboard, label: "Dashboard", path: "/Loan-Dashboard" },
    { icon: User, label: "Membership Form", path: "/membership" },
    { icon: Banknote, label: "Loan Form", path: "/loan" },
    { icon: HelpCircle, label: "Help & Support", path: "/lsupport" },
  ];
